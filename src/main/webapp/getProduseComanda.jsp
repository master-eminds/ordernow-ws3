        ...
        <div class="dashboard-ecommerce">
            <div class="container-fluid dashboard-content ">
                ...
                <c:if test="${not empty listaProduse}">
                    <div class="col-lg-12" style="max-height: 85%; max-width: 85%">
                        <h2 class="title-1 m-b-25">Lista produse</h2>
                            ...
                            <div class="au-card-inner">
                                <div class="table-responsive">
                                    <table class="table table-top-countries" style="background-color: #3873ff">
                                        <thead>
                                        <tr>
                                            <th style="color:white;">Denumire</th>
                                            <th style="color:white;">Pret</th>
                                            <th style="color:white;">Cantitate</th>
                                            <th style="color:white;">Valoare</th>
                ...
                <%--  <div class="row">
                      <c:if test="${not empty listaComenzi}">
                          <div class="col-lg-12">
                              <h2 class="title-1 m-b-25">Lista comenzi</h2>
                              <div class="au-card au-card--bg-blue au-card-top-countries m-b-40">
                                  <div class="au-card-inner">
                                      <div class="table-responsive">
                                          <table class="table table-top-countries" style="background-color: #3873ff">
                                              <thead>
                                              <tr>
                                                  <th style="color:white;">Numar comanda</th>
                                                  <th style="color:white;">Data</th>
                                                  <th style="color:white;">Ospatar</th>
                                                  <th style="color:white;">Numar produse</th>
                                                  <th style="color:white;">Vizualizare produse</th>
                                              ...
                                              <c:forEach var="comanda" items="${listaComenzi}">
                                                  <tr>
                                                      ...
                                                      <td>${comanda.listaItemComanda.size()}</td>
                                                      <td>
                                                          <a href="/getProduseComanda/${comanda.id}"><i class="fas fa-eye"></i></a>
                                                      </td>
