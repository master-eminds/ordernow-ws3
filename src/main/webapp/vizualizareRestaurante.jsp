                        ...
                        <li class="nav-item ">
                            ...
                            <div id="submenu-1" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/vizualizareRestaurante" >Vizualizare restaurante</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/adaugareRestaurant/0">Adauga restaurant</a>
                                    </li>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Vizualizare restaurante</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Vizualizare restaurante</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12">
                        <div class="row">
                            ...
                            <c:if test="${not empty restaurante}">
                                <c:forEach var="restaurant" items="${restaurante}">
                                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="product-thumbnail">
                                        <div class="product-img-head" style="margin:0 auto;" >
                                            <div class="product-img" style="margin:0 auto; height: 220px">
                                               <img src="${String(restaurant.imagine)}" style="margin: 0 auto; max-height: 80%; max-width: 80%; object-fit: cover" alt="" class="img-fluid"></div>
                                        </div>
                                        <div class="product-content" style="margin: 0 auto;height: 260px" >
                                                ...
                                                <h3 class="product-title">${restaurant.denumire}</h3>
                                                <div class="product-price">${restaurant.comandaOnline}</div>
                                                    <div class="product-price">${restaurant.barCode}</div>

                                                </div>
                                            <div class="product-btn">
                                                <a href="${contextPath}/adaugareRestaurant/${restaurant.id}" class="btn btn-outline-light">Modifica</a>
                                                <a href="${contextPath}/stergeRestaurant/${restaurant.id}" class="btn btn-danger btn-sm">Sterge</a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="product-sidebar">
                            <div class="product-sidebar-widget">
                                <a href="${contextPath}/adaugareRestaurant/0/"class="btn btn-danger btn-sm">Adauga un resutaurant</a>
                            </div>
                            <div class="product-sidebar-widget">
